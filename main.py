...
def main():
    ...
    # 1. Configuration (Using recent dates to ensure yfinance fundamental data exists)
    tickers = ['AAPL', 'MSFT', 'GOOGL', 'AMZN', 'META', 'BRK-B', 'JNJ', 'JPM', 'V', 'PG']
    start_date = "2025-08-01"
    end_date = "2026-08-20"
    
    # 2. Instantiate all modular engines
    ...
    # 7. Plot Cumulative Equity Curves
